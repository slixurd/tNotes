...
${OBJECTDIR}/ChangeNodeHandler.o: ChangeNodeHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChangeNodeHandler.o ChangeNodeHandler.cpp
...
${OBJECTDIR}/DeleteNodeHandler.o: DeleteNodeHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeleteNodeHandler.o DeleteNodeHandler.cpp
...
${OBJECTDIR}/SyncHandler.o: SyncHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SyncHandler.o SyncHandler.cpp

${OBJECTDIR}/database/dirRelated.o: database/dirRelated.cpp 
	${MKDIR} -p ${OBJECTDIR}/database
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/database/dirRelated.o database/dirRelated.cpp

${OBJECTDIR}/database/noteDB.o: database/noteDB.cpp 
	${MKDIR} -p ${OBJECTDIR}/database
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/database/noteDB.o database/noteDB.cpp

${OBJECTDIR}/database/noteRelated.o: database/noteRelated.cpp 
	${MKDIR} -p ${OBJECTDIR}/database
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/database/noteRelated.o database/noteRelated.cpp

${OBJECTDIR}/database/sha1.o: database/sha1.cpp 
	${MKDIR} -p ${OBJECTDIR}/database
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/database/sha1.o database/sha1.cpp
...
${TESTDIR}/tests/UnitTest4CreateArticleHandler.o: tests/UnitTest4CreateArticleHandler.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UnitTest4CreateArticleHandler.o tests/UnitTest4CreateArticleHandler.cpp


${TESTDIR}/tests/UnitTest4FecthArticlesHandler.o: tests/UnitTest4FecthArticlesHandler.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UnitTest4FecthArticlesHandler.o tests/UnitTest4FecthArticlesHandler.cpp


${TESTDIR}/tests/UnitTest4FecthBriefsHandler.o: tests/UnitTest4FecthBriefsHandler.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UnitTest4FecthBriefsHandler.o tests/UnitTest4FecthBriefsHandler.cpp
...
${TESTDIR}/tests/UnitTest4SyncHandler.o: tests/UnitTest4SyncHandler.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UnitTest4SyncHandler.o tests/UnitTest4SyncHandler.cpp
...
${OBJECTDIR}/ChangeNodeHandler_nomain.o: ${OBJECTDIR}/ChangeNodeHandler.o ChangeNodeHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChangeNodeHandler_nomain.o ChangeNodeHandler.cpp;\
	else  \
...
${OBJECTDIR}/DeleteNodeHandler_nomain.o: ${OBJECTDIR}/DeleteNodeHandler.o DeleteNodeHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeleteNodeHandler_nomain.o DeleteNodeHandler.cpp;\
	else  \
...
${OBJECTDIR}/SyncHandler_nomain.o: ${OBJECTDIR}/SyncHandler.o SyncHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SyncHandler_nomain.o SyncHandler.cpp;\
	else  \
...
${OBJECTDIR}/database/dirRelated_nomain.o: ${OBJECTDIR}/database/dirRelated.o database/dirRelated.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/database/dirRelated_nomain.o database/dirRelated.cpp;\
	else  \
...
${OBJECTDIR}/database/noteDB_nomain.o: ${OBJECTDIR}/database/noteDB.o database/noteDB.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/database/noteDB_nomain.o database/noteDB.cpp;\
	else  \
...
${OBJECTDIR}/database/noteRelated_nomain.o: ${OBJECTDIR}/database/noteRelated.o database/noteRelated.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/database/noteRelated_nomain.o database/noteRelated.cpp;\
	else  \
...
${OBJECTDIR}/database/sha1_nomain.o: ${OBJECTDIR}/database/sha1.o database/sha1.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/database/sha1_nomain.o database/sha1.cpp;\
	else  \
