...
${OBJECTDIR}/DB/dirRelated.o: DB/dirRelated.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DB/dirRelated.o DB/dirRelated.cpp
...
${OBJECTDIR}/DB/noteRelated.o: DB/noteRelated.cpp 
	${MKDIR} -p ${OBJECTDIR}/DB
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DB/noteRelated.o DB/noteRelated.cpp
...
${OBJECTDIR}/DB/dirRelated_nomain.o: ${OBJECTDIR}/DB/dirRelated.o DB/dirRelated.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DB/dirRelated_nomain.o DB/dirRelated.cpp;\
	else  \
...
${OBJECTDIR}/DB/noteRelated_nomain.o: ${OBJECTDIR}/DB/noteRelated.o DB/noteRelated.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DB/noteRelated_nomain.o DB/noteRelated.cpp;\
	else  \
